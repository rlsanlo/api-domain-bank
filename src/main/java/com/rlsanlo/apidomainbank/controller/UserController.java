...
import com.rlsanlo.apidomainbank.controller.dto.UserDto;
...
public record UserController(UserService userService) {
    ...
    @GetMapping
    @Operation(summary = "Get all users", description = "Retrieve a list of all registred users.")
    @ApiResponses(value = {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Operation sccessful."),
